...
- [x] **Merge su `main`** (`e0a20c1`), push su GitHub, branch eliminato e branch di produzione Netlify spostato su `main`. ⚠️ Che Netlify costruisca davvero da `main` si verifica **alla prima modifica visibile pushata**: `main` e il vecchio branch producevano un output identico, quindi ora non è distinguibile.
